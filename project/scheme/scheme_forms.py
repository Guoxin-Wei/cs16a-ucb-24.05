...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 10
        "*** YOUR CODE HERE ***"
        # formulas=signature.rest
        # validate_formals(formulas)
        # body=expressions.rest
        # lambda_procedure=LambdaProcedure(formulas,body,env)
        # env.define(signature.first,lambda_procedure)
        # return signature.first
        n_expression=Pair(signature.rest,expressions.rest)
        procedure=do_lambda_form(n_expression,env)
