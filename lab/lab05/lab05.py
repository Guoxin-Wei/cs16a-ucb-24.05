...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    if is_leaf(t):
        ...
        return t
    return tree(label(t),[replace_loki_at_leaf(son,lokis_replacement) for son in branches(t)])
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    return get_name(min(city_a,city_b,key=lambda x:distance(x,make_city('',lat,lon))))
...
def hailstone_tree(n, h):
    ...
    if n-1>3 and (n-1) % 3 ==0 and (n-1)//3%2==1:
